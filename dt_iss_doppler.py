...
for filename in os.listdir(path):
	if filename.startswith("s") or filename.startswith("k"):
		...
		for i in range(0,len(w)):
		     if w[i] > (1082.96+ref_value*5) and w[i]< (1083.09+ref_value*5): ### change back to the old wavelength range
		         w_temp.append(w[i])
		         p_temp.append(p[i])
		...
		os.chdir(r"/home/dtyler/Desktop/DocumentsDT/doppler_out")
		os.mkdir("images_"+fits_image_filename)
		os.chdir(r"/home/dtyler/Desktop/DocumentsDT/doppler_out/images_"+fits_image_filename)
		...
		os.chdir(r"/home/dtyler/Desktop/DocumentsDT/doppler_out/arrays")
		
		#fil = open("x_"+fits_image_filename[:-4]+".txt",'w')
		#fil.write(str(mplot2.x)+'\n')
		#fil.close()
		np.savetxt(fits_image_filename+"model_arrays.txt", np.c_[mplot2.x,y_cn])
		
		
		
		#fil = open("y_"+fits_image_filename[:-4]+".txt",'w')
		#fil.write(str(y_nc)+'\n')
		#fil.close()
		os.chdir(r"/home/dtyler/Desktop/DocumentsDT/Programs")
